...
- Your own branch + worktree, English commits, **author NexusHero <suhay.sevinc@gmail.com>** (the git
  ...
  `Co-authored-by: Enis <enis@steuereule-crew.example>` trailer** — the transparent AI-crew convention
  ...
  `Co-authored-by` is the ONLY trailer of that kind that ever appears.

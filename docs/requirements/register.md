...
by a bundled dependency. `better-auth`'s client bundle demonstrably contains one —
`localStorage.setItem` at `dist/client/broadcast-channel.mjs:19`. The honest bound was written into
